    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f3f6fd] py-12 px-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl px-8 py-10 flex flex-col items-center">
          ...
          {/* Title */}
          <h1 className="text-3xl font-bold text-center mb-1">AWLADNA</h1>
          <p className="text-gray-500 text-center mb-6">Welcome back to your parenting companion</p>
          ...
          <div className="mt-6 text-center">
            ...
            <Link to="/register" className="text-blue-600 font-medium hover:underline">Sign up here</Link>
          </div>
        </div>
      </div>
    </div>
